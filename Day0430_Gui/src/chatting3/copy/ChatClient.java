...
public class ChatClient extends JFrame implements KeyListener {
	...
	public ChatClient() {
		...
		textFieldIp.setBounds(234, 188, 180, 21);
		panel.add(textFieldIp);

		label = new JLabel("서버아이피");
		label.setBounds(234, 150, 106, 15);
		panel.add(label);

		btnConnect = new JButton("접속");
		btnConnect.setBounds(234, 233, 180, 23);
		panel.add(btnConnect);

		lblNick = new JLabel("닉네임을 입력해주세요");
		lblNick.setBounds(234, 43, 57, 15);
		panel.add(lblNick);
